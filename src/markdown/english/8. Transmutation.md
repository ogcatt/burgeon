...
Transmutation is the art of directly transferring the kept sexual energy (from semen retention) into productive expenditures which encourage growth. 

...

Retaining the energy is not enough. Learn to transmute it and convert it into success.
...
The sexual energy is such a hurricane of force that it needs to find an outlet. It's either going to find an outlet through a relapse or through transmutation in which you lift that energy upwards and outwards to bring to life the fruits of your labor, the desires that are in your heart.

Also just a quick note, you may feel a little more on-edge due to different changes in your body's chemistry. Keep your composure, as anger is its own punishment, as an angry person trying to push your head below water is drowning at the same time.
...
There are a number of physical outlets for transmutation. These are either physical or mental. Likely the most valuable outlet for sexual energy is creativity because it has infinite possibilites in what you can create and express.
...
I try to do at least some kind of exercise every morning, first thing in the morning and that is either lifting weights, calisthenics, going for a run or doing yoga and I highly highly encourage you to do the same.
